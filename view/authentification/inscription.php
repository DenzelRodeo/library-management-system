            ...
            <div class="card my-5 border-0 shadow">
                <form id="registerForm" class="card-body p-lg-5 card-body-color" method="post" action="#">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailError" class="error-msg">Veuillez entrer une adresse email valide.</div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="form-text text-center text-dark">
                        ...
                        <a href="connection.php" class="text-dark fw-bold" style="text-decoration:underline">Connectez-vous</a>
                    </div>
                </form>
            </div>
        </div>
