     ...
     <?php if (!empty($emprunts)): ?>
        <?php foreach ($emprunts as $emp): ?>
            <tr>
                ...
                <td>
                    <strong>LIV00<?= htmlspecialchars($emp['code_livre']) ?></strong><br>
                ...
                <td>
                    ...
                    <a href="modifier.php?code_etudiant=<?= $ligne['code_etudiant'] ?>&code_livre=<?= $ligne['code_livre'] ?>&date=<?= $ligne['date_emprunt'] ?>" 
